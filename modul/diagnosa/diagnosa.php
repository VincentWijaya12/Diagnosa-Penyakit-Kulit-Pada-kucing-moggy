...
?>
      <h2 class='text text-primary'>Melakukan Diagnosa Penyakit Kucing Moggy</h2>
      <hr>
      <div class='alert alert-success alert-dismissible'>
        ...
        Silahkan memilih gejala sesuai dengan kondisi kucing anda, anda dapat memilih kepastian kondisi kucing dari pasti
